...
public class GenerateAST {
  ...
  private static void defineAst(String outputDir, String baseName, List<String> types) throws IOException {
    ...
    writer.println("package com.zenghao.lox;");
    writer.println();
    ...
    // Base accept() method in abstract class
    writer.println();
  ...
  /**
   * Generate a Visitor interface by interating through the subcalsses and
   * declaring a visit method.
   */
